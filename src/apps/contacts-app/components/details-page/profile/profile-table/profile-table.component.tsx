...
import getValidUrl from 'apps/contacts-app/utils/get-valid-url'
...
import ClickToCall from 'apps/contacts-app/components/common/click-to-call/click-to-call.component'
import DefaultAction from './multi-row/default-action.component'
import ReadableEmail from 'apps/contacts-app/components/common/readable-email/readable-email.component'
import { Contact } from 'apps/contacts-app/api/fetch-contacts.api'
