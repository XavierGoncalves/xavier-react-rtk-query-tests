...
import { ROOT_URL, VIEW_CONTACT_ACTIVITY_URL, VIEW_CONTACT_URL } from 'apps/contacts-app/constants/url.constants'
...
import { LOADING } from 'apps/contacts-app/constants/state.constants'
import { ACTIVITY_TAB, PROFILE_TAB } from 'apps/contacts-app/constants/tabs.constants'
import useGetAccountCustomFields from 'react-query/custom-fields.queries'
import mergeCustomFields from 'apps/contacts-app/utils/merge-custom-fields'
...
import getDescription from 'apps/contacts-app/utils/get-description'
import getNavHeaderTitle from 'apps/contacts-app/utils/get-navheader-title'
import Profile from './profile/profile.component'
import useGetContact from 'apps/contacts-app/react-query/contact.queries'
