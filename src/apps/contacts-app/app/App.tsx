...
import ContactsPage from 'apps/contacts-app/components/contacts-page/contacts-page.component';
import FavoritesPage from 'apps/contacts-app/components/favorites/favorites-page.component';
import { QueryClientProvider } from '@tanstack/react-query';
import { queryClient } from 'react-query/query-client';
import { ReactQueryDevtools } from '@tanstack/react-query-devtools'
import CobaltRoot from '@cobalt/cobalt-react-components'
import DetailsPage from 'apps/contacts-app/components/details-page/details-page.component';
